...
## Create Dataset
    ...
    jar_glucose_conc <- glucose_mass / jar_volume
    jar_nitrogen_conc <- nitrogen_mass / jar_volume
    jar_phosphorus_conc <- phosphorus_mass / jar_volume
...
* addition_dates = the dates that the supplements were added to each treatment jar (YYYY-MM-DD).
...
* jar_glucose_conc = the increased concentration of glucose in the jar immediately after the supplement was added (mg/ml).

* jar_nitrogen_conc = the increased concentration of nitrogen in the jar immediately after the supplement was added (mgN/ml).

* jar_phosphorus_conc = the increased concentration of phosphorus in the jar immediately after the supplement was added (mgP/ml).